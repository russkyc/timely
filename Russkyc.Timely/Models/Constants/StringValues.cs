namespace Russkyc.Timely.Models.Constants;

public static class StringValues
{
    // AppVersion
    public const string AppVersion = "1.2.4 Stable";
    ...
    public const string IndexedDbTimeEntryTable = "indexed_timeentry_table";
}